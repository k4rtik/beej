...
#include <inttypes.h>  // for PRId32, PRId16
#include <stdarg.h>    // for va_list
#include <stdint.h>    // for uint8_t, int32_t, uint64_t, int16_t, int64_t
...
*/
static void packi16(uint8_t *buf, int16_t i) {
    uint16_t i2 = i;
...
*/
static void packi32(uint8_t *buf, int32_t i) {
    uint32_t i2 = i;
...
*/
static void packi64(uint8_t *buf, int64_t i) {
    uint64_t i2 = i;
...
*/
static int16_t unpacki16(uint8_t *buf) {
...
*/
static int64_t unpacki64(uint8_t *buf) {
...
*/
static int32_t pack(uint8_t *buf, char *format, ...) {
    va_list ap;
    int16_t h;
    int32_t l;
    int64_t L;
...
*/
static void unpack(uint8_t *buf, char *format, ...) {
    va_list ap;
    int16_t *h;
    int32_t *l;
    int64_t *L;
...
int main(void) {
    ...
    if (sizeof(float32_t) != 4 || sizeof(float64_t) != 8) {
        ...
        if (f32 == NULL || f64 == NULL) {
            printf(
                "I can't find the following size floating point types:%s%s\n\n",
